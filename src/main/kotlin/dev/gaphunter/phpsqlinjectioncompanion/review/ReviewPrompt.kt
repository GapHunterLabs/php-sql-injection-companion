package dev.gaphunter.phpsqlinjectioncompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.phpsqlinjectioncompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.phpsqlinjectioncompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "PHP SQL Injection Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33893-php-sql-injection-companion/reviews"
